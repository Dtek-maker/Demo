...
with col1:
    start_date = st.date_input('Start Date', '2025-02-18')

with col2:
    end_date= st.date_input('End Date', '2025-02-26')
    ...
    for parameter in tag_index_mapping.values():
        ...
        fig.update_layout(
            ...
            xaxis=dict(showgrid=True
                # tickformat='%d'
              ),  # Display only the day as a number (1, 2, 3, etc.)       ),
            yaxis=dict(showgrid=True, range=y_range, fixedrange=True),
